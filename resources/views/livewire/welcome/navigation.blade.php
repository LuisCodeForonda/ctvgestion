<nav class="-mx-3 flex flex-1 justify-end">
    ...
    @else
        ...
        @if (Route::has('register'))
            <a
                href="{{ route('register') }}"
                class="rounded-md px-3 py-2  ring-1 ring-transparent transition focus:outline-none focus-visible:ring-[#FF2D20] text-white text-white/80 dark:focus-visible:ring-white"
            >
                Register
            </a>
        @endif
