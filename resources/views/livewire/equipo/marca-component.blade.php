<div class="p-4">
    ...
    <x-modalx name="edit" title="Hello world">
        @slot('body')
            Modal edit
        @endslot
    </x-modalx>

    <x-modalx name="new" title="Hello world">
        @slot('body')
    ...
    <div class="flex justify-between items-center py-2">
        ...
        <button x-data x-on:click="$dispatch('open-modal', { name: 'new'})" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Nuevo</button> 
        <button x-data x-on:click="$dispatch('open-modal', { name: 'edit'})" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Nuevo</button> 
